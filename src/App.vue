    ...
    " id="projects">
      ...
      <div class="min-w-full flex flex-col items-center">
        ...
        <div class="flex gap-5">
          <input @click="tryLast" type="button" class="w-14 h-8 rounded-full bg-gray-600 hover:bg-gray-700 cursor-pointer text-white text-center text-xl font-bold duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" value="<-">
          <div class="h-8 w-14 bg-gray-600 flex rounded-full text-white"><p class="m-auto">{{ page }} / {{ pages }}</p></div>
          <input @click="tryNext" type="button" class="w-14 h-8 rounded-full bg-gray-600 hover:bg-gray-700 cursor-pointer text-white text-center text-xl font-bold duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" value="->">
        </div>
